          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center ml-4 lg:ml-0">
              <button
                ...
                className="flex items-center space-x-3 text-purple-900 hover:text-purple-700 transition-colors"
              >
                <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold text-sm">BL</span>
                </div>
                <div className="hidden sm:block">
                  <span className="text-xl font-bold">Behavioral Learning</span>
                  <div className="text-xs text-amber-600">Platform</div>
                </div>
              </button>
            </div>
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                  <div className="p-4 border-b border-gray-100">
                    <div className="flex items-center space-x-3">
                      <div className="w-12 h-12 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full flex items-center justify-center text-white font-medium">
                        {user?.firstName?.[0]}{user?.lastName?.[0]}
                      </div>
                      <div>
